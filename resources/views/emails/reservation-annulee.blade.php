...
<head>
    ...
    <style>
        ...
        .header { background: #e53e3e; padding: 2rem; text-align: center; }
        ...
        .card { background: #fff5f5; border: 1px solid #fed7d7; border-radius: 10px; padding: 1.25rem; margin: 1.5rem 0; }
        .card-row { display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #fed7d7; font-size: 0.9rem; }
        .card-row:last-child { border-bottom: none; }
        .card-row .label { color: #718096; }
        .card-row .value { font-weight: 600; color: #2d3748; }
        .badge { display: inline-block; background: #fed7d7; color: #c53030; padding: 0.3rem 0.85rem; border-radius: 100px; font-size: 0.8rem; font-weight: 600; }
...
<div class="container">
    ...
    <div class="body">
        ...
        <p>Votre réservation a été <strong>annulée</strong>. Voici le récapitulatif :</p>
        ...
        <div class="card">
            ...
            <div class="card-row">
                ...
                <span class="value"><span class="badge">❌ Annulée</span></span>
            </div>
        </div>

        <p style="color: #718096; font-size: 0.9rem;">
            Vous pouvez effectuer une nouvelle réservation à tout moment depuis votre espace patient.
        </p>
    </div>
    <div class="footer">
